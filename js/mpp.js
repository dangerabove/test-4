  ...
  fire3: function() {
    ...
    text3Kill: function(){
      ...
      eweapon1.fireRate -= 1.25;
      	...
      	game.physics.arcade.overlap(eweapon5.bullets, player, function(sb1, splayer){splayer.kill(); console.log('dostales 1'); scrpp += 2; cntpp+=1;});
        game.physics.arcade.overlap(eweapon2.bullets, player, function(sb1, splayer){splayer.kill(); console.log('dostales 1'); scrpp += 2; cntpp+=1;});
        game.physics.arcade.overlap(eweapon3.bullets, player, function(sb1, splayer){splayer.kill(); console.log('dostales 1'); scrpp += 2; cntpp+=1;});
        game.physics.arcade.overlap(eweapon4.bullets, player, function(sb1, splayer){splayer.kill(); console.log('dostales 1'); scrpp += 2; cntpp+=1;});
      	game.physics.arcade.overlap(eweapon1.bullets, player, function(sb5, splayer){splayer.kill(); console.log('dostales 5'); scrpp += 2; cntpp+=1;});
        game.physics.arcade.overlap(bul5.bullets, player, function(sb5, splayer){splayer.kill(); console.log('dostales 5'); scrpp += 5; cntpp+=1;});
